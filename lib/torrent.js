...
_.locallyValidateTorrent = function(torrent, callback) {
    ...
    if(typeof torrent.subcategory.id === 'undefined' || torrent.subcategory.id === null) {
        ...
        if(!(torrent.subcategory.id.length === 3 && /[1-5]/.test(torrent.subcategory.id.toString().charAt(0)))) {
